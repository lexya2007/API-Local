...
history_collection=../Postman_Collections_APIs/v3.0/API-ContactHistory.json
...
canvas_collection_share=../Postman_Collections_APIs/v3.0/API-Canvas_share.json
echo "Collection: $canvas_collection"
echo "Environment: $environment"
...
project_collection_share=../Postman_Collections_APIs/v3.0/API-Projects_share.json
echo "Collection: $project_collection"
echo "Environment: $environment"
...
urlbookmark_collection=../Postman_Collections_APIs/v2.2/API-URLBookmark.json
...
recentobject_collection=../Postman_Collections_APIs/v2.2/API-RecentObject.json
echo "Collection: $recentobject_collection"
echo "Environment: $environment"
newman run $recentobject_collection -e $environment --insecure

link_collection=../Postman_Collections_APIs/v3.0/API-Link-Shared.json
